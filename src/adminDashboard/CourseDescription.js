                ...
                <div className="flex mx-auto max-w-7xl justify-between py-8 relative">
                    ...
                    <div className="pl-20 ">
                        <div className="text-sm breadcrumbs">
                            <ul>
                                <li className="hover:text-blue-400"><Link style={{ textDecoration: "none" }} to='/'
                                    onClick={() => setSearchTerm("")}>HOME</Link></li>
                                <li className="hover:text-blue-400"><Link style={{ textDecoration: "none" }} to='/dashboard'
                                    onClick={() => setSearchTerm(savedItem?.courseTitle)}> {savedItem?.courseTitle}</Link></li>
